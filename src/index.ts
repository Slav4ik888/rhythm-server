...
// git add . && git commit -m "started sendNotifications after registration by partner's link" && git push -u origin main
// service rhythm-server restart updated version to 1.48.1
